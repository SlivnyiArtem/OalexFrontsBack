...
def visualize_citation_graph(citation_matrix, clusters, G, min_cluster_size=5, window_sim_threshold=(0.0, 0.3,
                                                                                                     0.5)):  # старый метод общего графа(без ранжирования по окнам)
